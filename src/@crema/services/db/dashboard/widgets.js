const widgetsData = {
  ...
  colorsList: [
	  {id: 1, name: 'Red', color: '#e53935', isChecked: false},
	  {id: 2, name: 'Blue', color: '#1e88e5', isChecked: false},
	  {id: 3, name: 'Green', color: '#43a047', isChecked: true},
	  {id: 4, name: 'Purple', color: '#6a1b9a', isChecked: false},
	  {id: 5, name: 'Orange', color: '#fb8c00', isChecked: true},
	  {id: 6, name: 'Pink', color: '#d81b60', isChecked: false},
	  {id: 7, name: 'Black', color: 'black', isChecked: false},
	  {id: 8, name: 'Light Grey', color: '#bdbdbd', isChecked: false},
	  {id: 9, name: 'Red', color: '#e53935', isChecked: false},
  ],
  tagsList: [
    {id: 9001, label: 'Primary', color: '#1e88e5'},
    {id: 9002, label: 'Secondary', color: '#e53935'},
    {id: 9003, label: 'Error', color: '#43a047'},
    {id: 9004, label: 'Ui Kit', color: '#fb8c00'},
  ],
  reviewsList: [
    {
      id: 100001,
