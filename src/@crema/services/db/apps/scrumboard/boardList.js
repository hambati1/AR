        ...
        cards: [
          {
            ...
            label: [
              {id: 301, label: 'High Priority', type: 1, color: '#dc3545'},
              {id: 302, label: 'Important', type: 2, color: '#198754'},
            ],
          ...
          },
          {
            ...
            label: [
              {id: 303, label: 'Crema', type: 3, color: 'primary.main'},
              {id: 304, label: 'Work Place', type: 4, color: 'text.secondary'},
            ],
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            attachments: [],
            label: [{id: 303, label: 'Crema', type: 3, color: 'primary.main'}],
