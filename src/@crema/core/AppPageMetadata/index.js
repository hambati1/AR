...
const defaultTitle = 'PNG Guardian';
const defaultDescription =
  'PNG Guardian Partcipant Management System';
const defaultImage =
  'https://firebasestorage.googleapis.com/v0/b/crema-demo.appspot.com/o/logo512.png?alt=media';
const defaultTwitter = '@PNG';
const defaultSep = ' | ';
  ...
  const getMetaTags = (
    {
      ...
      updated,
      category = 'ATD, CMS, Offender Management ',
      tags = 'ATD, Offender Management, Participant Management, CMS, Jail Management Systems ',
    },
    pathname,
  ) => {
