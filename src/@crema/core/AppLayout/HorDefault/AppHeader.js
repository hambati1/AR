...
const AppHeader = ({showDrawer}) => {
  ...
  return (
    <div className={styles.appHeaderHor}>
      <NotificationBar/>

      <div className={styles.headerHorMain}>
        <div className={styles.container}>
          <div className={styles.headerHorMainFlex}>
      ...
      <div
        className={styles.headerNavHor}
        style={{
          backgroundColor: sidebarColorSet.sidebarBgColor,
          color: sidebarColorSet.sidebarTextColor,
        }}>
        <div className={styles.container}>
          <AppHorizontalNav className={styles.appMainHorMenu} />
        </div>
      </div>
    </div>
  );
