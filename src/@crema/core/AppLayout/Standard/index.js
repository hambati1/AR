...
const Standard = () => {
  ...
  return (
    <div
      ...
      <div className={styles.appLayoutStandardInner}>
        <AppHeader/>
        <div className={styles.appLayoutStandardRow}>
          <AppSidebar/>
          <div className={styles.appLayoutStandardMain}>
            <AppScrollbar className={styles.standardMainScrollbar}>
              <AppContentView/>
