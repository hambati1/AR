  ...
  return (
    <>
      ...
      <AppRowSimpleContainer>
        ...
        <Col xs={12} xl={6} key='reactColor-m'>
          <ComponentCard
        ...
        <Col xs={12} xl={6} key='reactColor-n'>
          <ComponentCard
            title='Custom Picker'
        ...
        <Col xs={12} xl={6} key='reactColor-o'>
          <ComponentCard
        ...
        <Col xs={12} xl={6} key='reactColor-p'>
          <ComponentCard
        ...
        <Col xs={12} xl={6} key='reactColor-q'>
          <ComponentCard title='Photoshop Picker' component={PhotoshopPicker} />
        </Col>
        <Col xs={12} xl={6} key='reactColor-r'>
